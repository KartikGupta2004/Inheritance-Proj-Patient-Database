      ...
      <div className='flex justify-center border-white bg-MedicalBg'>
        <div className='flex flex-col justify-center items-center bg-white  sm:rounded-lg w-full sm:max-w-xl lg:rounded-none lg:rounded-l-lg lg:mr-0 lg:ml-0 lg:max-w-3xl my-60'>
          <form
            ...
            className='flex flex-col justify-center items-center min-h-loginh gap-4 p-6'
          >
            ...
            <hr className='-mt-2' />
            {error && (
              <div className='bg-stone-300 text-red-600 rounded-lg'>
                {error}
              </div>
            )}
            <input
            ...
            <button
              type='submit'
              disabled={isLoading}
              className='px-4 h-12 my-2 py-7 text-3xl rounded-lg mt-10 font-medium pl-6 flex text-white bg-blue-600 hover:bg-blue-800 justify-center w-56 items-center'
            >
            ...
            <button
              type='button'
              onClick={() => logout()}
              className='border-blue-600 border-2 p-2 rounded-lg text-blue-600'
            >
              Logout
            </button>
          </form>
