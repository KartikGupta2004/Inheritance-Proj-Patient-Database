...
const BloodGlucoseForm = () => {
  return (
    <main className='flex justify-center items-center max-w-screen-Login h-fit mx-auto box-border'>
      <div className='flex justify-center items-center w-full h-fit box-border flex-col bg-stone-100'>
        ...
        <section className='p-6 text-4xl mt-16 box-border h-fit'>
          <form
            action=''
          ...
          >
            ...
            <span className='sm:col-span-2 mt-4'>
              ...
              <div className='flex justify-around flex-wrap mt-4 '>
                <span className='bg-white rounded-lg py-2 px-4 my-2 mx-4'>
                  <input
                    type='radio'
                    name='type'
                    id='fasting'
            ...
            <span className='flex justify-center sm:col-span-2'>
              <button className='rounded-full font-bold text-3xl px-5 py-3 my-4 bg-rose-400 text-white'>
                Save Record
              </button>
            </span>
          </form>
