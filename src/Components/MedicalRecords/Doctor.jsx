...
function Doctor() {
  return (
    ...
    <p className='text-3xl sm:text-4xl lg:text-5xl lg:pl-40'>Doctor</p>
    ...
    <div className='text-2xl sm:text-4xl lg:text-5xl space-y-2 '>
        <img className='w-40 lg:w-72 flex mx-auto justify-center' src="Medical page/doctor.png" alt="" />
        {/* Baki hai */}
        <p className='font-bold'>No Data</p>
        <div className='text-gray-400'>
        <p >Click Add Button and</p>
        <p>Enter Doctor's Data</p>
        </div>
    </div>
    </div>
    </div>
