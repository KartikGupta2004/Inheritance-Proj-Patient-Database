...
const Examination = () => {
  ...
  const handleChange = (e) => {
    if (e.target.name === 'tempunit' || e.target.name === 'weightunit' || e.target.name === 'heightunit') {
          ...
          >
            <span className='flex sm:col-span-2 justify-center'>
              ...
              >
                ...
                <p className="mt-4">{data.file ? "Change File" : "Upload File"}</p>
                <input
                  type='file'
                  name='file'
                  id='file'
            ...
            <span>
              <label htmlFor='temperature' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Temperature:
              </label>
              <input
                type='number'
            ...
            <span>
              <label htmlFor='tempunit' className='flex  text-gray-500 right-0 justify-end mt-10 mb-5'>
                Unit:
              </label>
              <select
                name='tempunit'
            ...
            <span>
              <label htmlFor='weight' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Weight:
              </label>
              <input
                type='number'
            ...
            <span>
              <label htmlFor='weightunit' className='flex  text-gray-500 right-0 justify-end mt-10 mb-5'>
                Unit:
              </label>
              <select
                name='weightunit'
            ...
            <span>
              <label htmlFor='height' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Height:
              </label>
              <input
                type='number'
            ...
            <span>
              <label htmlFor='heightunit' className='flex  text-gray-500 right-0 justify-end mt-10 mb-5'>
                Unit:
              </label>
              <select
                name='heightunit'
            ...
            <span className='flex flex-col sm:col-span-2'>
              <label htmlFor='symptom' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Symptoms:
              </label>
                ...
                <div className='bg-white w-full rounded-lg text-2xl p-4 my-3'>
                  <ul>
                    {data.symptoms.map((sym, id) => {
                      return (
                        <li key={id} className='flex flex-row justify-evenly text-gray-500'>
            ...
            <span className='flex flex-col sm:col-span-2'>
              <label htmlFor='diagnosis' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Diagnoses:
              </label>
              <div className='flex flex-row gap-2 justify-evenly items-center py-2 box-border'>
                <input
            ...
            <span>
              <label htmlFor='doctor' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Doctor:
              </label>
              <input
                type='text'
            ...
            <span className='sm:col-span-2'>
              <label htmlFor='note' className='flex  text-gray-500 left-0 justify-start mt-10 mb-5'>
                Note:
                </label>
              <textarea
                name='rec_note'
