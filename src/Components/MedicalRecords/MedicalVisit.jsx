...
function MedicalVisit() {
  ...
  return (
    ...
    <FaFilter className='hover:cursor-pointer' onClick={toggleDropdown}/>
    {isDropdownVisible && (
    ...
    <TbArrowsSort  className='hover:cursor-pointer' onClick={toggleDropdown}/>
    <BsThreeDotsVertical  className='hover:cursor-pointer' onClick={toggleDropdown}/>
    <div>
      <p className='text-4xl'><img className='w-10 h-10' src="Assets/printer.png" alt="" />Print</p>
      <p className='text-4xl'><img className='w-10 h-10' src="Assets/pdf.png" alt="" />Pdf Share</p>
    </div>
    </div>
    </div>
    </div>
    ...
    :(visits.map((visit)=>(
    <div key={visits.id} className='flex justify-center items-center'>
